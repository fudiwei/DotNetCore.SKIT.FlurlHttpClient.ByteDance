...
{
    /// <summary>
    /// <para>表示 [GET] /apps/v1/capacity/query_simple_qr_bind_list 接口的响应。</para>
    /// </summary>
    public class AppsCapacityQuerySimpleQrcodeBindListV1Response : ByteDanceMicroAppResponse
    {
