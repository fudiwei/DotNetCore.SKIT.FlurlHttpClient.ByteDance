...
{
    /// <summary>
    /// <para>表示 [POST] /openapi/v1/microapp/operation/add_share_tpl 接口的请求。</para>
    /// </summary>
    public class OpenApiMicroAppOperationAddShareTemplateV1Request : ByteDanceMicroAppRequest
    {
        /// <summary>
