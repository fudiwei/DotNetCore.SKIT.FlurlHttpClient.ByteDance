namespace SKIT.FlurlHttpClient.ByteDance.TikTokGlobalShop.Models
{
    ...
    /// </summary>
    public class OrdersDetailQueryResponse : TikTokShopResponse<OrdersDetailQueryResponse.Types.Data>
    {
        public static class Types
        {
            public class Data
            {
                public static class Types
                {
                    public class Order : OrdersSearchResponse.Types.Data.Types.Order
                    {
                        public static class Types
                        {
