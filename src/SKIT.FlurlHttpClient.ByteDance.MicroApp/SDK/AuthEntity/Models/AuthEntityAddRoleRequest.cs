...
{
    public class AuthEntityAddRoleRequest : ByteDanceMicroAppAuthEntityRequest
    {
        public static class Types
        {
            ...
            public class InstitutionRoleInfo
            {
                /// <summary>
                /// 机构基础信息
                /// </summary>
                ...
                public InstitutionClassInfo? InstitutionClassInfo { get; set; }
            }

            public class InstitutionClassInfo
            {
                ...
                public CertificateMaterial? ClassMaterial { get; set; }
            }
        ...
        public Types.InstitutionRoleInfo? InstitutionRoleInfo { get; set; }
    }
}
