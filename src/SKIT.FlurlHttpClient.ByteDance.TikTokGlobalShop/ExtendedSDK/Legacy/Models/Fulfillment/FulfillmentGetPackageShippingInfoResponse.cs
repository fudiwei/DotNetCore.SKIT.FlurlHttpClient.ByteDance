...
{
    /// <summary>
    /// <para>表示 [GET] /fulfillment/shipping_info 接口的响应。</para>
    /// </summary>
    public class FulfillmentGetPackageShippingInfoResponse : TikTokShopLegacyResponse<FulfillmentGetPackageShippingInfoResponse.Types.Data>
    {
