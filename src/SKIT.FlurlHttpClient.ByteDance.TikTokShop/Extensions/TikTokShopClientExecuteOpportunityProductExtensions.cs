...
{
    public static class TikTokShopClientExecuteOpportunityProductExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static async Task<Models.OpportunityProductApplyResponse> ExecuteOpportunityProductApplyAsync(this TikTokShopClient client, Models.OpportunityProductApplyRequest request, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.OpportunityProductClueResponse> ExecuteOpportunityProductClueAsync(this TikTokShopClient client, Models.OpportunityProductClueRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.OpportunityProductGetApplyProgressResponse> ExecuteOpportunityProductGetApplyProgressAsync(this TikTokShopClient client, Models.OpportunityProductGetApplyProgressRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
