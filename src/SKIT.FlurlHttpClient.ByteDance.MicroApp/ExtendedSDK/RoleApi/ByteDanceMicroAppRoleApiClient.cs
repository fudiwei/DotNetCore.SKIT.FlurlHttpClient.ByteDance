...
{
    /// <summary>
    /// 一个字节小程序泛知识角色系统 API HTTP 客户端。
    /// </summary>
    public class ByteDanceMicroAppRoleApiClient : CommonClientBase, ICommonClient
    {
        /// <summary>
        /// 获取当前客户端使用的字节小程序凭证。
        /// </summary>
        ...
        /// <summary>
        /// 用指定的配置项初始化 <see cref="ByteDanceMicroAppRoleApiClient"/> 类的新实例。
        /// </summary>
        /// <param name="options">配置项。</param>
        public ByteDanceMicroAppRoleApiClient(ByteDanceMicroAppRoleApiClientOptions options)
            : this(options, null)
        {
        }
        ...
        internal protected ByteDanceMicroAppRoleApiClient(ByteDanceMicroAppRoleApiClientOptions options, HttpClient? httpClient, bool disposeClient = true)
            : base(httpClient, disposeClient)
        {
            ...
            FlurlClient.BaseUrl = options.Endpoints ?? ByteDanceMicroAppRoleApiEndpoints.DEFAULT;
        ...
        /// <returns></returns>
        public IFlurlRequest CreateFlurlRequest(ByteDanceMicroAppRoleApiRequest request, HttpMethod httpMethod, params object[] urlSegments)
        {
        ...
        public async Task<T> SendFlurlRequestAsync<T>(IFlurlRequest flurlRequest, HttpContent? httpContent = null, CancellationToken cancellationToken = default)
            where T : ByteDanceMicroAppRoleApiResponse, new()
        {
