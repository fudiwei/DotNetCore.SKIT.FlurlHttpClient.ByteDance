...
namespace SKIT.FlurlHttpClient.ByteDance.TikTokGlobalShop.ExtendedSDK.Legacy
{
    ...
    public static class TikTokShopLegacyClientExecuteGlobalProductExtensions
    {
        ...
        /// <returns></returns>
        public static async Task<Models.GlobalProductSearchProductsResponse> ExecuteGlobalProductSearchProductsAsync(this TikTokShopLegacyClient client, Models.GlobalProductSearchProductsRequest request, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.GlobalProductGetProductDetailResponse> ExecuteGlobalProductGetProductDetailAsync(this TikTokShopLegacyClient client, Models.GlobalProductGetProductDetailRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.GlobalProductCreateProductResponse> ExecuteGlobalProductCreateProductAsync(this TikTokShopLegacyClient client, Models.GlobalProductCreateProductRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.GlobalProductUpdateProductResponse> ExecuteGlobalProductUpdateProductAsync(this TikTokShopLegacyClient client, Models.GlobalProductUpdateProductRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.GlobalProductUpdateProductPriceResponse> ExecuteGlobalProductUpdateProductPriceAsync(this TikTokShopLegacyClient client, Models.GlobalProductUpdateProductPriceRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.GlobalProductPublishProductResponse> ExecuteGlobalProductPublishProductAsync(this TikTokShopLegacyClient client, Models.GlobalProductPublishProductRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.GlobalProductDeleteProductsResponse> ExecuteGlobalProductDeleteProductsAsync(this TikTokShopLegacyClient client, Models.GlobalProductDeleteProductsRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.GlobalProductGetCategoryListResponse> ExecuteGlobalProductGetCategoryListAsync(this TikTokShopLegacyClient client, Models.GlobalProductGetCategoryListRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.GlobalProductGetAttributeListResponse> ExecuteGlobalProductGetAttributeListAsync(this TikTokShopLegacyClient client, Models.GlobalProductGetAttributeListRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.GlobalProductGetCategoryRulesResponse> ExecuteGlobalProductGetCategoryRulesAsync(this TikTokShopLegacyClient client, Models.GlobalProductGetCategoryRulesRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
