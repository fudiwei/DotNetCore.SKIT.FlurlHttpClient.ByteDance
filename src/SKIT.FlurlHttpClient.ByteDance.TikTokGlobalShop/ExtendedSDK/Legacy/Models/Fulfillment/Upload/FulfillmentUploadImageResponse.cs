...
{
    /// <summary>
    /// <para>表示 [POST] /fulfillment/uploadimage 接口的响应。</para>
    /// </summary>
    public class FulfillmentUploadImageResponse : TikTokShopLegacyResponse<FulfillmentUploadImageResponse.Types.Data>
    {
