...
{
    /// <summary>
    /// <para>表示 [GET] /api/apps/v1/data_analysis/query_deal_overview_data 接口的响应。</para>
    /// </summary>
    [Obsolete("相关接口或字段于 2024-02-02 下线。")]
    public class AppsDataAnalysisQueryDealOverviewDataV1Response : DouyinMicroAppResponse
    {
