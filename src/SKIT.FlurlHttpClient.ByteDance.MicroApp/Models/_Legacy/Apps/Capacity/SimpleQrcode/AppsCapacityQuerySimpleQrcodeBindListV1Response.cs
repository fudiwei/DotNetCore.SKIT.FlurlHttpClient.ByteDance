...
{
    /// <summary>
    /// <para>表示 [GET] /api/apps/v1/capacity/query_simple_qr_bind_list 接口的响应。</para>
    /// </summary>
    [Obsolete("相关接口或字段于 2024-02-02 下线。")]
    public class AppsCapacityQuerySimpleQrcodeBindListV1Response : DouyinMicroAppResponse
    {
