...
namespace SKIT.FlurlHttpClient.ByteDance.OceanEngine
{
    public static class OceanEngineClientExecuteCampaignExtensions
    {
        ...
        /// <para>REF: https://open.oceanengine.com/doc/index.html?key=ad&type=api&id=1696710532657164 </para>
        /// </summary>
        ...
        public static async Task<Models.CampaignGetResponse> ExecuteCampaignGetAsync(this OceanEngineClient client, Models.CampaignGetRequest request, CancellationToken cancellationToken = default)
        {
            ...
            IFlurlRequest flurlReq = client
                .CreateRequest(request, HttpMethod.Get, "2", "campaign", "get")
                .WithHeader("Access-Token", request.AccessToken);

            return await client.SendRequestWithJsonAsync<Models.CampaignGetResponse>(flurlReq, data: request, cancellationToken: cancellationToken);
        }

        /// <summary>
        /// <para>异步调用 [POST] /2/campaign/create 接口。</para>
        /// <para>REF: https://open.oceanengine.com/doc/index.html?key=ad&type=api&id=1696710533142540 </para>
        /// </summary>
        /// <param name="client"></param>
        /// <param name="request"></param>
        /// <param name="cancellationToken"></param>
        ...
        public static async Task<Models.CampaignCreateResponse> ExecuteCampaignCreateAsync(this OceanEngineClient client, Models.CampaignCreateRequest request, CancellationToken cancellationToken = default)
        {
            ...
            IFlurlRequest flurlReq = client
                .CreateRequest(request, HttpMethod.Post, "2", "campaign", "create")
                .WithHeader("Access-Token", request.AccessToken);

            return await client.SendRequestWithJsonAsync<Models.CampaignCreateResponse>(flurlReq, data: request, cancellationToken: cancellationToken);
        }
        ...
        public static async Task<Models.CampaignUpdateResponse> ExecuteCampaignUpdateAsync(this OceanEngineClient client, Models.CampaignUpdateRequest request, CancellationToken cancellationToken = default)
        {
            ...
            IFlurlRequest flurlReq = client
                .CreateRequest(request, HttpMethod.Post, "2", "campaign", "update")
                .WithHeader("Access-Token", request.AccessToken);

            return await client.SendRequestWithJsonAsync<Models.CampaignUpdateResponse>(flurlReq, data: request, cancellationToken: cancellationToken);
        }

        /// <summary>
        /// <para>异步调用 [POST] /2/campaign/update/status 接口。</para>
        /// <para>REF: https://open.oceanengine.com/doc/index.html?key=ad&type=api&id=1696710534164480 </para>
        /// </summary>
        /// <param name="client"></param>
        /// <param name="request"></param>
        /// <param name="cancellationToken"></param>
        ...
        public static async Task<Models.CampaignUpdateStatusResponse> ExecuteCampaignUpdateStatusAsync(this OceanEngineClient client, Models.CampaignUpdateStatusRequest request, CancellationToken cancellationToken = default)
        {
            ...
            IFlurlRequest flurlReq = client
                .CreateRequest(request, HttpMethod.Post, "2", "campaign", "update", "status")
                .WithHeader("Access-Token", request.AccessToken);

            return await client.SendRequestWithJsonAsync<Models.CampaignUpdateStatusResponse>(flurlReq, data: request, cancellationToken: cancellationToken);
        }
    }
}
