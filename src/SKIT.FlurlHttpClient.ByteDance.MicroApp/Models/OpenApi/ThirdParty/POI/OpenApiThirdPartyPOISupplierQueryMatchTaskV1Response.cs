...
{
    /// <summary>
    /// <para>表示 [GET] /openapi/v1/tp/poi/supplier/query/match_task 接口的响应。</para>
    /// </summary>
    public class OpenApiThirdPartyPOISupplierQueryMatchTaskV1Response : ByteDanceMicroAppResponse
    {
