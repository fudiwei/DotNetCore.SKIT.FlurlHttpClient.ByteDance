...
namespace SKIT.FlurlHttpClient.ByteDance.MicroApp.ExtendedSDK.OpenApi
{
    ...
    public class ByteDanceMicroAppOpenApiClient : CommonClientBase, ICommonClient
    {
        ...
        internal protected ByteDanceMicroAppOpenApiClient(ByteDanceMicroAppOpenApiClientOptions options, HttpClient? httpClient, bool disposeClient = true)
        ...
        /// <returns></returns>
        public IFlurlRequest CreateFlurlRequest(ByteDanceMicroAppOpenApiRequest request, HttpMethod httpMethod, params object[] urlSegments)
        {
