...
{
    /// <summary>
    /// <para>表示 [GET] /openapi/v1/microapp/operation/query_shop_material 接口的响应。</para>
    /// </summary>
    public class OpenApiMicroAppOperationQueryShopMaterialV1Response : ByteDanceMicroAppResponse
    {
