...
namespace SKIT.FlurlHttpClient.ByteDance.TikTokGlobal
{
    ...
    public class TikTokClient : CommonClientBase, ICommonClient
    {
        ...
        internal protected TikTokClient(TikTokClientOptions options, HttpClient? httpClient, bool disposeClient = true)
        ...
        /// <returns></returns>
        public IFlurlRequest CreateFlurlRequest(TikTokRequest request, HttpMethod httpMethod, params object[] urlSegments)
        {
