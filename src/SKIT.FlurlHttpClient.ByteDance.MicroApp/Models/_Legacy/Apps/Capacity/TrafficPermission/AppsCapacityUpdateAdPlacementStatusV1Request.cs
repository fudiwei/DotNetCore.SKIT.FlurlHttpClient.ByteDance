...
{
    /// <summary>
    /// <para>表示 [POST] /api/apps/v1/capacity/update_ad_placement_status 接口的请求。</para>
    /// </summary>
    [Obsolete("相关接口或字段于 2024-02-29 下线。")]
    public class AppsCapacityUpdateAdPlacementStatusV1Request : DouyinMicroAppRequest
    {
        /// <summary>
        /// 获取或设置广告位 ID。
        /// </summary>
