...
{
    /// <summary>
    /// <para>表示 [POST] /promotion/activity/deactivate 接口的响应。</para>
    /// </summary>
    public class PromotionDeactivateActivityResponse : TikTokShopLegacyResponse<PromotionDeactivateActivityResponse.Types.Data>
    {
