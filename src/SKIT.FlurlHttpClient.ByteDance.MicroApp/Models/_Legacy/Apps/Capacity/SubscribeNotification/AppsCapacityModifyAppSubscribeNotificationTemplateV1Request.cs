...
{
    /// <summary>
    /// <para>表示 [POST] /api/apps/v1/capacity/modify_app_subscribe_notification_tpl 接口的请求。</para>
    /// </summary>
    [Obsolete("相关接口或字段于 2024-01-30 下线。")]
    public class AppsCapacityModifyAppSubscribeNotificationTemplateV1Request : DouyinMicroAppRequest
    {
        /// <summary>
        /// 获取或设置小程序消息模版 ID。
        /// </summary>
