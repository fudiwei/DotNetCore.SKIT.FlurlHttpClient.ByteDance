...
namespace SKIT.FlurlHttpClient.ByteDance.TikTokGlobalShop.ExtendedSDK.Legacy.Models
{
    ...
    /// </summary>
    public class GlobalProductUpdateProductRequest : TikTokShopLegacyRequest
    {
        public static class Types
        {
            ...
            public class GlobalSKU
            {
                public static class Types
                {
                    ...
                    public class StockInfo : GlobalProductCreateProductRequest.Types.GlobalSKU.Types.StockInfo
                    {
                    }
                }
