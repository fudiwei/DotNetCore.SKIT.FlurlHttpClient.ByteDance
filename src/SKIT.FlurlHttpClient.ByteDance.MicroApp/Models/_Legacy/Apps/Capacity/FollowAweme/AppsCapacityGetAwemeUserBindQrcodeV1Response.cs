...
{
    /// <summary>
    /// <para>表示 [GET] /api/apps/v1/capacity/get_aweme_user_bind_qrcode 接口的响应。</para>
    /// </summary>
    [Obsolete("相关接口或字段于 2024-01-01 下线。")]
    public class AppsCapacityGetAwemeUserBindQrcodeV1Response : DouyinMicroAppResponse
    {
