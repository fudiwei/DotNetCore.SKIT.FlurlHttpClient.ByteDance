namespace SKIT.FlurlHttpClient.ByteDance.TikTokShop.Events
{
    ...
    /// <para>REF: https://op.jinritemai.com/docs/message-docs/31/118 </para>
    /// </summary>
    public class RefundBuyerReturnGoodsEvent : TikTokShopEvent<RefundBuyerReturnGoodsEvent.Types.Data>
    {
