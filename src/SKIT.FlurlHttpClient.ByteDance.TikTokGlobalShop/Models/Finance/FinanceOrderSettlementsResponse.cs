namespace SKIT.FlurlHttpClient.ByteDance.TikTokGlobalShop.Models
{
    ...
    /// </summary>
    public class FinanceOrderSettlementsResponse : TikTokShopResponse<FinanceOrderSettlementsResponse.Types.Data>
    {
            ...
            public class Data
            {
                public static class Types
                {
                    public class Settlement
                    {
                        public static class Types
                        {
                            public class SettlementInfo : FinanceSettlementsSearchResponse.Types.Data.Types.Settlement.Types.SettlementInfo
                            {
                            }
                        }
