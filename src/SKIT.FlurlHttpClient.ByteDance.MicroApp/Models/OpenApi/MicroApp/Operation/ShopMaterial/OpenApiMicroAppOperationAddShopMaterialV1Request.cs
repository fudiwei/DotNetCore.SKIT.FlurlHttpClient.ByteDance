...
{
    /// <summary>
    /// <para>表示 [POST] /openapi/v1/microapp/operation/add_shop_material 接口的请求。</para>
    /// </summary>
    public class OpenApiMicroAppOperationAddShopMaterialV1Request : ByteDanceMicroAppRequest
    {
