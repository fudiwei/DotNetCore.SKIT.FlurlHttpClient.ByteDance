...
{
    public static class TikTokShopClientExecuteStorageExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static async Task<Models.StorageNotifySaleReturnStatusResponse> ExecuteStorageNotifySaleReturnStatusAsync(this TikTokShopClient client, Models.StorageNotifySaleReturnStatusRequest request, CancellationToken cancellationToken = default)
        {
