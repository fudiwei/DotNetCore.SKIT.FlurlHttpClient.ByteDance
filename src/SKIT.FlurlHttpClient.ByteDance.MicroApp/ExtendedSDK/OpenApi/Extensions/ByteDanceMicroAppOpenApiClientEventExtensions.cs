...
namespace SKIT.FlurlHttpClient.ByteDance.MicroApp.ExtendedSDK.OpenApi
{
    ...
    public static partial class ByteDanceMicroAppOpenApiClientEventExtensions
    {
        ...
        /// <returns></returns>
        public static TEvent DeserializeEventFromJson<TEvent>(this ByteDanceMicroAppOpenApiClient client, string webhookJson)
            where TEvent : ByteDanceMicroAppOpenApiEvent, new()
        {
        ...
        /// <param name="webhookJson"></param>
        /// <returns></returns>
        public static ByteDanceMicroAppOpenApiEvent DeserializeEventFromJson(this ByteDanceMicroAppOpenApiClient client, string webhookJson)
        {
            return InnerDeserializeEventFromJson<ByteDanceMicroAppOpenApiEvent>(client, webhookJson);
        }
        ...
        /// <returns></returns>
        public static TEvent DeserializeEventFromXml<TEvent>(this ByteDanceMicroAppOpenApiClient client, string webhookXml)
            where TEvent : ByteDanceMicroAppOpenApiEvent, new()
        {
        ...
        /// <param name="webhookXml"></param>
        /// <returns></returns>
        public static ByteDanceMicroAppOpenApiEvent DeserializeEventFromXml(this ByteDanceMicroAppOpenApiClient client, string webhookXml)
        {
            return InnerDeserializeEventFromXml<ByteDanceMicroAppOpenApiEvent>(client, webhookXml);
        }
        ...
        /// <param name="webhookJson"></param>
        /// <returns></returns>
        public static ErroredResult VerifyEventSignatureFromJson(this ByteDanceMicroAppOpenApiClient client, string webhookJson)
        {
        ...
        /// <param name="webhookXml"></param>
        /// <returns></returns>
        public static ErroredResult VerifyEventSignatureFromXml(this ByteDanceMicroAppOpenApiClient client, string webhookXml)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
    ...
    partial class ByteDanceMicroAppOpenApiClientEventExtensions
    {
        ...
        private static TEvent InnerDeserializeEventFromJson<TEvent>(ByteDanceMicroAppOpenApiClient client, string webhookJson)
        ...
        private static TEvent InnerDeserializeEventFromXml<TEvent>(ByteDanceMicroAppOpenApiClient client, string webhookXml)
            where TEvent : ByteDanceMicroAppOpenApiEvent
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
