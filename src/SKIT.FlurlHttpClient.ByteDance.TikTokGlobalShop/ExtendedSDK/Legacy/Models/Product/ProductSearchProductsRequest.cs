...
{
    /// <summary>
    /// <para>表示 [POST] /products/search 接口的请求。</para>
    /// </summary>
    public class ProductSearchProductsRequest : TikTokShopLegacyRequest
    {
        /// <summary>
        /// 获取或设置创建时间范围起始时间戳。
        /// </summary>
        ...
        /// 获取或设置商品状态。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("search_status")]
        [System.Text.Json.Serialization.JsonPropertyName("search_status")]
