...
namespace SKIT.FlurlHttpClient.ByteDance.MicroApp.ExtendedSDK.ProductApi
{
    ...
    public class ByteDanceMicroAppProductApiClient : CommonClientBase, ICommonClient
    {
        ...
        internal protected ByteDanceMicroAppProductApiClient(ByteDanceMicroAppProductApiClientOptions options, HttpClient? httpClient, bool disposeClient = true)
        ...
        /// <returns></returns>
        public IFlurlRequest CreateFlurlRequest(ByteDanceMicroAppProductApiRequest request, HttpMethod httpMethod, params object[] urlSegments)
        {
