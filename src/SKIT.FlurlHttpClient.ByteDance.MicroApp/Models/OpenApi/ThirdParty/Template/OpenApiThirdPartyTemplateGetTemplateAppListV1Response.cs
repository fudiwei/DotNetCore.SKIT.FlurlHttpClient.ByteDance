...
{
    /// <summary>
    /// <para>表示 [GET] /openapi/v1/tp/template/get_tpl_app_list 接口的响应。</para>
    /// </summary>
    public class OpenApiThirdPartyTemplateGetTemplateAppListV1Response : ByteDanceMicroAppResponse
    {
