...
{
    /// <summary>
    /// <para>表示 [GET] /api/apps/v1/capacity/query_capcut_template_list 接口的响应。</para>
    /// </summary>
    [Obsolete("相关接口或字段于 2024-01-01 下线。")]
    public class AppsCapacityQueryCapcutTemplateListV1Response : DouyinMicroAppResponse
    {
