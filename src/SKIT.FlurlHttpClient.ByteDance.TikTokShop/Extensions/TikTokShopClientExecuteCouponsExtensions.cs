...
{
    public static class TikTokShopClientExecuteCouponsExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static async Task<Models.CouponsCancelVerifyResponse> ExecuteCouponsCancelVerifyAsync(this TikTokShopClient client, Models.CouponsCancelVerifyRequest request, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.CouponsAbandonResponse> ExecuteCouponsAbandonAsync(this TikTokShopClient client, Models.CouponsAbandonRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.CouponsSyncV2Response> ExecuteCouponsSyncV2Async(this TikTokShopClient client, Models.CouponsSyncV2Request request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.CouponsVerifyV2Response> ExecuteCouponsVerifyV2Async(this TikTokShopClient client, Models.CouponsVerifyV2Request request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
