...
{
    public static class TikTokShopClientExecuteAftersaleExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static async Task<Models.AftersaleTimeExtendResponse> ExecuteAftersaleTimeExtendAsync(this TikTokShopClient client, Models.AftersaleTimeExtendRequest request, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.AftersaleBuyerExchangeResponse> ExecuteAftersaleBuyerExchangeAsync(this TikTokShopClient client, Models.AftersaleBuyerExchangeRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.AftersaleAddOrderRemarkResponse> ExecuteAftersaleAddOrderRemarkAsync(this TikTokShopClient client, Models.AftersaleAddOrderRemarkRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.AftersaleSubmitEvidenceResponse> ExecuteAftersaleSubmitEvidenceAsync(this TikTokShopClient client, Models.AftersaleSubmitEvidenceRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.AftersaleOpenAfterSaleChannelResponse> ExecuteAftersaleOpenAfterSaleChannelAsync(this TikTokShopClient client, Models.AftersaleOpenAfterSaleChannelRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.AftersaleBuyerExchangeConfirmResponse> ExecuteAftersaleBuyerExchangeConfirmAsync(this TikTokShopClient client, Models.AftersaleBuyerExchangeConfirmRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.AftersaleCancelSendGoodsSuccessResponse> ExecuteAftersaleCancelSendGoodsSuccessAsync(this TikTokShopClient client, Models.AftersaleCancelSendGoodsSuccessRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.AftersaleReturnGoodsToWareHouseSuccessResponse> ExecuteAftersaleReturnGoodsToWareHouseSuccessAsync(this TikTokShopClient client, Models.AftersaleReturnGoodsToWareHouseSuccessRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.AftersaleOperateResponse> ExecuteAftersaleOperateAsync(this TikTokShopClient client, Models.AftersaleOperateRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
