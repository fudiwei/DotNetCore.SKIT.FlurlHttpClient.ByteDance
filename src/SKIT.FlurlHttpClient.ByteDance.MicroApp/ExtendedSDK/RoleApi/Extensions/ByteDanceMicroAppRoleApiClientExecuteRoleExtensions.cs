...
{
    public static class ByteDanceMicroAppRoleApiClientExecuteRoleExtensions
    {
        /// <summary>
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.AuthEntityBindRoleResponse> ExecuteAuthEntityBindRoleAsync(this ByteDanceMicroAppRoleApiClient client, Models.AuthEntityBindRoleRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
