...
namespace SKIT.FlurlHttpClient.ByteDance.TikTokGlobalShop.Models
{
    ...
    /// </summary>
    public class ProductsUpdateRequest : TikTokShopRequest
    {
        public static class Types
        {
            public class Image : ProductsCreateRequest.Types.Image
            {
            }

            public class Video : ProductsCreateRequest.Types.Video
            {
            }

            public class SizeChart : ProductsCreateRequest.Types.SizeChart
            {
            }

            public class ProductCertification : ProductsCreateRequest.Types.ProductCertification
            {
                public static new class Types
                {
                    public class Image : ProductsCreateRequest.Types.ProductCertification.Types.Image
                    {
                    }

                    public class File : ProductsCreateRequest.Types.ProductCertification.Types.File
                    {
                    }
                }
            ...
            public class SKU : ProductsCreateRequest.Types.SKU
            {
                public static new class Types
                {
                    public class SalesAttribute : ProductsCreateRequest.Types.SKU.Types.SalesAttribute
                    {
                        public static new class Types
                        {
                            public class Image : ProductsCreateRequest.Types.SKU.Types.SalesAttribute.Types.Image
                            {
                            }
                        }
                    ...
                    public class StockInfo : ProductsCreateRequest.Types.SKU.Types.StockInfo
                    {
                    }

                    public class IdentifierCodeInfo : ProductsCreateRequest.Types.SKU.Types.IdentifierCodeInfo
                    {
                    }
                }
            ...
            public class ProductAttribute : ProductsCreateRequest.Types.ProductAttribute
            {
                public static new class Types
                {
                    public class ProductAttributeValue : ProductsCreateRequest.Types.ProductAttribute.Types.ProductAttributeValue
                    {
                    }
                }
            ...
            public class ExemptionOfIdentifierCode : ProductsCreateRequest.Types.ExemptionOfIdentifierCode
            {
            }
        }
