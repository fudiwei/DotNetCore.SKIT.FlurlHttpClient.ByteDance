...
{
    public static class TikTokClientExecuteNamekExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static async Task<Models.NamekFulfilmentPrepareResponse> ExecuteNamekFulfilmentPrepareAsync(this TikTokClient client, Models.NamekFulfilmentPrepareRequest request, CancellationToken cancellationToken = default)
        {
