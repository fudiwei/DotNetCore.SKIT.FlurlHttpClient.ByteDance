...
{
    public static class TikTokShopClientExecuteSKUExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static async Task<Models.SKUListResponse> ExecuteSKUListAsync(this TikTokShopClient client, Models.SKUListRequest request, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.SKUDetailResponse> ExecuteSKUDetailAsync(this TikTokShopClient client, Models.SKUDetailRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.SKUEditPriceResponse> ExecuteSKUEditPriceAsync(this TikTokShopClient client, Models.SKUEditPriceRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.SKUEditCodeResponse> ExecuteSKUEditCodeAsync(this TikTokShopClient client, Models.SKUEditCodeRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.SKUSyncStockBatchResponse> ExecuteSKUSyncStockBatchAsync(this TikTokShopClient client, Models.SKUSyncStockBatchRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.SKUSyncStockResponse> ExecuteSKUSyncStockAsync(this TikTokShopClient client, Models.SKUSyncStockRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task<Models.SKUStockNumberResponse> ExecuteSKUStockNumberAsync(this TikTokShopClient client, Models.SKUStockNumberRequest request, CancellationToken cancellationToken = default)
        {
            if (client is null) throw new ArgumentNullException(nameof(client));
            if (request is null) throw new ArgumentNullException(nameof(request));
